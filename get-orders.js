...
const SHEET_CSV_URL = process.env.SHEET_ORDERS_CSV_URL || process.env.SHEET_CSV_URL || '';
...
exports.handler = async (event) => {
  ...
  if (!SHEET_CSV_URL) {
    return { statusCode: 500, headers, body: JSON.stringify({ error: 'SHEET_ORDERS_CSV_URL is not configured' }) };
  }
